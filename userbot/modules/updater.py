...
async def deploy(event, repo, ups_rem, ac_br, txt):
    if HEROKU_API_KEY is not None:
        ...
        await event.edit('`[HEROKU]:'
                         '\nUpdate Deploy XBOT=LINCXLN-, Silahkan Tunggu 5-8 menit..`'
                         )
        ups_rem.fetch(ac_br)
...
async def update(event, repo, ups_rem, ac_br):
    ...
    await event.edit('**XBOT-LINCXLN** Berhasil Di Update✓')
    await asyncio.sleep(1)
    await event.edit('`XBOT-LINCXLN Di Restart....`')
    await asyncio.sleep(1)
    ...
    if BOTLOG:
        await event.client.send_message(
            ...
            "XBOT-LINCXLN Berhasil Di Update✓")
        await asyncio.sleep(10)
        await event.delete()
...
async def upstream(event):
    ...
    if conf is None and force_update is False:
        changelog_str = f'**UPDATE Terbaru Untuk 🔥XBOT-LINCXLN🔥 [{ac_br}]:\n\nPERUBAHAN:**\n`{changelog}`'
    ...
    if force_update:
        ...
        await event.edit('`Proses Update XBOT-LINCXLN, ....🛠️`')
        await event.edit('`Proses Update XBOT-LINCXLN, loading....🛠️`')
        await event.edit('`Proses Update XBOT-LINCXLN, updating....🛠️`')
        await event.edit('`Proses Update XBOT-LINCXLN\nSilahkan tunggu....🛠️`')
    if conf == "now":
